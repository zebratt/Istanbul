    ...
    render() {
        return (
            <div id="Charge">
                ...
                <Route exact path="/center/home/charge/bankcard" component={Bankcard} />
                <Route exact path="/center/home/charge/alipay" component={Alipay} />
                <Route
                    exact
                    path="/center/home/charge/online"
                    render={() => <Online {...this.props} />}
                />
            </div>
        )
    }
...
class Online extends React.Component {
    ...
    onSubmitHandler = eve => {
        ...
        const params = [`amount=${amountVal}`, `paymod=plain`, `customerId=${userId}`]
